                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                style= "padding: 50px 15px; color: #4b4b4b;">
                                    <h4>Dekripsi</h4>
                                    <p>Dekripsi adalah pengolahan data menjadi sesuatu yang dapat diutarakan secara jelas dan tepat dengan tujuan dimengerti oleh orang yang tidak langsung mengalaminya sendiri. Enkripsi pada aplikasi ini adalah Kombinasi Chipper Key dan Caesar Chipper</p>
                                </div>
                                <div class="col-md-5" style= "padding: 10px; color: white;">
                                    <!-- start Form Enkripsi -->
                                    <form action="" method="post" style="padding: 0px; margin: 0 auto;">
                        ...
                        <div class="col-md-6" style="padding-top: 15px;">
                            <h5>Hasil Pesan Dekripsi</h5>
                                ...
                                if (isset($_POST['klik2'])) {
                                    ...
                                    $cipherText2 = Decipher($plainText, $kunci); ?>
...
<!--Footer-->
      <footer class="page-footer font-small stylish-color-dark pt-4 mt-4"  style="background-color:#00FFFF">
          <!--Footer Links-->
          <div class="container text-center text-md-left">
              ...
              <div class="row text-center text-md-left mt-3 pb-3">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 mx-auto mt-3">
                      ...
                      <p>Aplikasi pembuat pesan enkripsi chipper key dengan Caesar Chipper ini dibuat untuk memenuhi tugas mata kuliah Kriptografi</p>
                  </div>
                  <!--/.First column-->
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 mx-auto mt-3">
                      ...
                      <i class="fa fa-home"></i>Universitas Bina Sarana Informatika, Jatiwaringin<br/>
                      <i class="fa fa-envelope"></i> mnadhifalghifari@gmail.com<br/>
                      <i class="fa fa-phone"></i>Phone : +68 89505037491<br/>
                      <i class="fa fa-instagram"></i>IG : @ghifari0108_ & @ghifari_mn
                  </div>
              </div>
              <hr>
              <div class="row d-flex align-items-center">
                  ...
                  <div class="col-md-8 col-lg-8">
                      <!--Copyright-->
                      <p class="text-center text-md-left grey-text">© 2022 Copyright Muhammad Nadhif Alghifari-17191131</p>
                      <!--/.Copyright-->
                  </div>
                  <!--Grid column-->
              </div>
